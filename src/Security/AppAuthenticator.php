...
class AppAuthenticator extends AbstractLoginFormAuthenticator
{
    ...
    public function __construct(private UrlGeneratorInterface $urlGenerator, private DocumentManager $dm, private CsrfTokenManagerInterface $csrfTokenManager)
    {
    }
    ...
    public function authenticate(Request $request): Passport
    {
        ...
        return new Passport(
            new UserBadge($email, function(string $userIdentifier) use($dm){
                $user = $dm->getRepository(User::class)->findOneBy(['email' => $userIdentifier]);
                if (!$user) {
